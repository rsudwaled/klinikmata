<div class="card">
    ...
    <div class="card-body">
                ...
                <div class="col-12" id="accordion">
                    <div class="card card-danger card-outline">
                        ...
                        <div id="collapseNine{{ $r->id }}" class="collapse" data-parent="#accordion">
                            <div class="card-body">
                                <button class="btn btn-info mb-3 btndetailorder" kodekunjungan="{{ $r->id }}"
                                    data-toggle="modal" data-target="#modaldetailtindakan">Tindakan & Order Farmasi
                                </button>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        @if ($r->id_perawat != null)
                                            ...
                                            <table class="table mt-4">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="text-bold text-md">{{ $r->nama_perawat }}</td>
                                                        <td>
                                    ...
                                    <div class="card-body">
                                        @if ($r->id_dokter != null)
                                            <table class="table table-sm">
                                                <tr>
                                                    <td class="text-bold">Tanggal & Jam Kunjungan</td>
                                                    <td class="font-italic text-bold text-md">{{ $r->tgl_kunjungan }}
                                                    </td>
                                                    <td class="text-bold">Tanggal & Jam Pemeriksaan</td>
                                                    <td class="font-italic text-bold text-md">{{ $r->tgl_pemeriksaan }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-bold">Keluhan Utama Pasien</td>
                                                    <td class="font-italic text-bold text-md">{{ $r->keluhan_pasien }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-bold">Sumber Data</td>
                                                    <td class="font-italic text-bold text-md">{{ $r->sumber_data }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-bold">Tekanan Darah</td>
                                                    <td class="font-italic text-bold text-md">{{ $r->tekanan_darah }}
                                                    </td>
                                                    <td class="text-bold">Frekuensi Nadi</td>
                                                    <td class="font-italic text-bold text-md">{{ $r->frekuensi_nadi }}
                                                        x / menit</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-bold">Frekuensi Nafas</td>
                                                    <td class="font-italic text-bold text-md">{{ $r->frekuensi_nafas }}
                                                        x / menit</td>
                                                    <td class="text-bold">Suhu Tubuh</td>
                                                ...
                                                <tr>
                                                    <td class="text-bold">Riwayat Alergi</td>
                                                    <td class="font-italic text-bold text-md">{{ $r->riwayat_alergi }}
                                                    </td>
                                                    <td class="text-bold">Keterangan Alergi</td>
                                                    <td class="font-italic text-bold text-md">
                                                        {{ $r->keterangan_alergi }}</td>
                                                </tr>
                                            </table>
                                            ...
                                            <table class="table table-sm mt-3">
                                                ...
                                                <tr>
                                                    <td colspan="6" class="text-bold text-center bg-danger">
                                                        PEMERIKSAAN KHUSUS</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="6" class="text-bold text-center bg-secondary">
                                                        Visus Dasar</td>
                                                </tr>
                                                <tr>
                                                    <td>OD</td>
                                                ...
                                                <tr>
                                                    <td colspan="5" class="text-bold text-center bg-secondary">
                                                        Lensometer</td>
                                                </tr>
                                                <tr>
                                                    <td>OD:Sph</td>
                                                ...
                                                <tr>
                                                    <td colspan="6" class="text-bold text-center bg-warning">
                                                        PENANDAAN GAMBAR</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="3">
                                            ...
                                            <table class="table mt-4">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="text-bold text-md">{{ $r->nama_dokter }}</td>
                                                        <td>
        ...
        @endforeach
        <!-- Modal -->
        <div class="modal fade" id="modaldetailtindakan" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Tindakan & Order Farmasi</h5>
