...
@section('title', 'Order Obat')
@section('content_header')
    <h1 class="m-0 text-dark">Order Obat</h1>
@stop
@section('content')
    <div class="row">
        <div class="col-12">
            <x-adminlte-card title="Order Obat" theme="secondary" collapsible>
                <div class="row">
                    <div class="col-md-8 mb-2">
                        ...
                        <x-adminlte-button label="Import" class="btn-sm btnImport" theme="warning" title="Import"
                            icon="fas fa-plus" />
                        <a href="{{ route('obat.index') }}" class="btn btn-sm btn-warning"><i class="fas fa-sync"></i>
                            Refresh</a>
                    </div>
                </div>
                @php
    ...
    <x-adminlte-modal id="modalImport" title="Import Obat" theme="success" v-centered>
    ...
    <x-adminlte-modal id="modal" title="Data Obat" theme="success" v-centered>
        <form action="" id="form">
            @csrf
            {{-- <div class="row">
                <div class="col-md-6">
    ...
    <script>
        $(function() {
            ...
            $('.btnEdit').click(function() {
                var id = $(this).data('id');
                $.LoadingOverlay("show");
                $.get("{{ route('obat.index') }}" + '/' + id + '/edit', function(data) {
                    console.log(data);
                    $('#id').val(data.id);
                    $('#kode').val(data.kode);
