...
class NotaPembelianController extends APIController
{
    ...
    {
        $nota = NotaPembelian::with(['supplier', 'barang','user'])->get();
    ...
    public function store(Request $request)
    {
        ...
        $request['kode'] = "NPB" . now()->format('dm') . str_pad(NotaPembelian::whereDate('created_at', now()->today())->count() + 1, 4, '0', STR_PAD_LEFT);;
